...
namespace YueMod.Items.PileBunker {
	public class PileBunkerProjectile01 : ModProjectile {
        ...
        public override void AI() {
            AnimeProjectile(); 
            var dust = Dust.NewDustDirect(Projectile.Center + new Vector2(-10, -5), 0, 0, DustID.LavaMoss, 0f, -3f, 255, default, 0.8f);
            var dust2 = Dust.NewDustDirect(Projectile.Center + new Vector2(-10, 0), 0, 0, DustID.Shadowflame, 0f, -5f, 255, new Color(252, 3, 82), 0.7f);
